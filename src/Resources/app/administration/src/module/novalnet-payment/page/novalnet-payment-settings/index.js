		...
		checkBackendConfiguration() {
			...
			this.NovalPaymentApiCredentialsService.validateApiCredentials(clientId, accessKey).then((response) => {
				...
				}else
				{
                    ...
                    //this.config['NovalnetPayment.settings.clientId'] = this.config['NovalnetPayment.settings.clientId'].replace(/\s/g, "");
                    //this.config['NovalnetPayment.settings.accessKey'] = this.config['NovalnetPayment.settings.accessKey'].replace(/\s/g, "");
