        ...
        if ($request->get('orderNumber')) {
            ...
            if (!is_null($transactionData)) {
                ...
                if (!is_null($orderReference)) {
                    $response =  $this->transactionHelper->refundTransaction($transactionData, $orderReference, $context, (int) $refundedAmount, $request, true);
                }
            }
        }
        ...
        if ($request->get('status') && $request->get('orderNumber')) {
            ...
            if (!is_null($transactionData)) {
                ...
                if (!is_null($orderReference)) {
                    ...
                    $response =  $this->transactionHelper->manageTransaction($transactionData, $orderReference, $context, $status, true);
                }
            }
        }
        return new JsonResponse($response);
